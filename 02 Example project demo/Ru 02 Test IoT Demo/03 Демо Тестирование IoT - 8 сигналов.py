...
VDC(value=1,   value_limit=40, percent_error=70, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=3.00, remeasurement=True, remeasurement_number=3, hash='Измерение 1$VDC_RECTANGLE')  #hash Измерение 1$VDC_RECTANGLE:   1  ;40  ;70  ;rectangle ;1  ;10  ;10к  ;0.800  ;Да  ;3
VDC(value=2,   value_limit=40, percent_error=30, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 2$VDC_RECTANGLE')  #hash Измерение 2$VDC_RECTANGLE:   2  ;40  ;30  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=3,   value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 3$VDC_RECTANGLE')  #hash Измерение 3$VDC_RECTANGLE:   3  ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=4,   value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 4$VDC_RECTANGLE')  #hash Измерение 4$VDC_RECTANGLE:   4  ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=5,   value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 5$VDC_RECTANGLE')  #hash Измерение 5$VDC_RECTANGLE:   5  ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=6,   value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 6$VDC_RECTANGLE')  #hash Измерение 6$VDC_RECTANGLE:   6  ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=8,   value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 7$VDC_RECTANGLE')  #hash Измерение 7$VDC_RECTANGLE:   8  ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=10,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 8$VDC_RECTANGLE')  #hash Измерение 8$VDC_RECTANGLE:   10 ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=12,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 9$VDC_RECTANGLE')  #hash Измерение 9$VDC_RECTANGLE:   12 ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=14,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 10$VDC_RECTANGLE') #hash Измерение 10$VDC_RECTANGLE:  14 ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=16,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 11$VDC_RECTANGLE') #hash Измерение 11$VDC_RECTANGLE:  16 ;40  ;20  ;rectangle ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=18,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 12$VDC_RECTANGLE') #hash Измерение 12$VDC_RECTANGLE:  18 ;40  ;20  ;rectangle ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=20,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 13$VDC_RECTANGLE') #hash Измерение 13$VDC_RECTANGLE:  20 ;40  ;20  ;rectangle ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=22,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 14$VDC_RECTANGLE') #hash Измерение 14$VDC_RECTANGLE:  22 ;40  ;20  ;rectangle ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=25,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=3, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 15$VDC_RECTANGLE') #hash Измерение 15$VDC_RECTANGLE:  25 ;40  ;20  ;rectangle ;3  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=28,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=3, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 16$VDC_RECTANGLE') #hash Измерение 16$VDC_RECTANGLE:  28 ;40  ;20  ;rectangle ;3  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=31,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=4, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 17$VDC_RECTANGLE') #hash Измерение 17$VDC_RECTANGLE:  31 ;40  ;20  ;rectangle ;4  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=34,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 18$VDC_RECTANGLE') #hash Измерение 18$VDC_RECTANGLE:  34 ;40  ;20  ;rectangle ;5  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=37,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 19$VDC_RECTANGLE') #hash Измерение 19$VDC_RECTANGLE:  37 ;40  ;20  ;rectangle ;5  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=40,  value_limit=40, percent_error=20, wave='rectangle',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 20$VDC_RECTANGLE') #hash Измерение 20$VDC_RECTANGLE:  40 ;40  ;20  ;rectangle ;5  ;10  ;10к  ;0.050  ;Да  ;3
...
VDC(value=1,   value_limit=40, percent_error=70, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=3.00, remeasurement=True, remeasurement_number=3, hash='Измерение 1$VDC_TRAPEZOID')  #hash Измерение 1$VDC_TRAPEZOID:   1  ;40  ;70  ;trapezoid ;1  ;10  ;10к  ;0.800  ;Да  ;3
VDC(value=2,   value_limit=40, percent_error=30, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 2$VDC_TRAPEZOID')  #hash Измерение 2$VDC_TRAPEZOID:   2  ;40  ;30  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=3,   value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 3$VDC_TRAPEZOID')  #hash Измерение 3$VDC_TRAPEZOID:   3  ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=4,   value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 4$VDC_TRAPEZOID')  #hash Измерение 4$VDC_TRAPEZOID:   4  ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=5,   value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 5$VDC_TRAPEZOID')  #hash Измерение 5$VDC_TRAPEZOID:   5  ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=6,   value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 6$VDC_TRAPEZOID')  #hash Измерение 6$VDC_TRAPEZOID:   6  ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=8,   value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 7$VDC_TRAPEZOID')  #hash Измерение 7$VDC_TRAPEZOID:   8  ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=10,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 8$VDC_TRAPEZOID')  #hash Измерение 8$VDC_TRAPEZOID:   10 ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=12,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 9$VDC_TRAPEZOID')  #hash Измерение 9$VDC_TRAPEZOID:   12 ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=14,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 10$VDC_TRAPEZOID') #hash Измерение 10$VDC_TRAPEZOID:  14 ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=16,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=1, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 11$VDC_TRAPEZOID') #hash Измерение 11$VDC_TRAPEZOID:  16 ;40  ;20  ;trapezoid ;1  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=18,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 12$VDC_TRAPEZOID') #hash Измерение 12$VDC_TRAPEZOID:  18 ;40  ;20  ;trapezoid ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=20,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 13$VDC_TRAPEZOID') #hash Измерение 13$VDC_TRAPEZOID:  20 ;40  ;20  ;trapezoid ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=22,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=2, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 14$VDC_TRAPEZOID') #hash Измерение 14$VDC_TRAPEZOID:  22 ;40  ;20  ;trapezoid ;2  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=25,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=3, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 15$VDC_TRAPEZOID') #hash Измерение 15$VDC_TRAPEZOID:  25 ;40  ;20  ;trapezoid ;3  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=28,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=3, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 16$VDC_TRAPEZOID') #hash Измерение 16$VDC_TRAPEZOID:  28 ;40  ;20  ;trapezoid ;3  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=31,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=4, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 17$VDC_TRAPEZOID') #hash Измерение 17$VDC_TRAPEZOID:  31 ;40  ;20  ;trapezoid ;4  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=34,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 18$VDC_TRAPEZOID') #hash Измерение 18$VDC_TRAPEZOID:  34 ;40  ;20  ;trapezoid ;5  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=37,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 19$VDC_TRAPEZOID') #hash Измерение 19$VDC_TRAPEZOID:  37 ;40  ;20  ;trapezoid ;5  ;10  ;10к  ;0.050  ;Да  ;3
VDC(value=40,  value_limit=40, percent_error=20, wave='trapezoid',  amplitude=5, amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 20$VDC_TRAPEZOID') #hash Измерение 20$VDC_TRAPEZOID:  40 ;40  ;20  ;trapezoid ;5  ;10  ;10к  ;0.050  ;Да  ;3
...
IDC(value=0.01, value_limit=5, percent_error=220, wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=3.00, remeasurement=True, remeasurement_number=3, hash='Измерение 1$IDC_CMOS')   #hash Измерение 1$IDC_CMOS:  0.01 ;5  ;230 ;CMOS ;1  ;10  ;10к  ;0.800  ;Да  ;3
IDC(value=0.03, value_limit=5, percent_error=110, wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 2$IDC_CMOS')   #hash Измерение 2$IDC_CMOS:  0.03 ;5  ;110 ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.05, value_limit=5, percent_error=55,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 3$IDC_CMOS')   #hash Измерение 3$IDC_CMOS:  0.05 ;5  ;55  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.1,  value_limit=5, percent_error=35,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 4$IDC_CMOS')   #hash Измерение 4$IDC_CMOS:  0.1  ;5  ;35  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.15, value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 5$IDC_CMOS')   #hash Измерение 5$IDC_CMOS:  0.15 ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.2,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 6$IDC_CMOS')   #hash Измерение 6$IDC_CMOS:  0.2  ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.25, value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 7$IDC_CMOS')   #hash Измерение 7$IDC_CMOS:  0.25 ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.3,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 8$IDC_CMOS')   #hash Измерение 8$IDC_CMOS:  0.3  ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.4,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 9$IDC_CMOS')   #hash Измерение 9$IDC_CMOS:  0.4  ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.5,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 10$IDC_CMOS')  #hash Измерение 10$IDC_CMOS: 0.5  ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.6,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 11$IDC_CMOS')  #hash Измерение 11$IDC_CMOS: 0.6  ;5  ;20  ;CMOS ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.8,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 12$IDC_CMOS')  #hash Измерение 12$IDC_CMOS: 0.8  ;5  ;20  ;CMOS ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1,    value_limit=5, percent_error=20,  wave='CMOS', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 13$IDC_CMOS')  #hash Измерение 13$IDC_CMOS: 1    ;5  ;20  ;CMOS ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1.2,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 14$IDC_CMOS')  #hash Измерение 14$IDC_CMOS: 1.2  ;5  ;20  ;CMOS ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1.5,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=3,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 15$IDC_CMOS')  #hash Измерение 15$IDC_CMOS: 1.5  ;5  ;20  ;CMOS ;3  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=2,    value_limit=5, percent_error=20,  wave='CMOS', amplitude=3,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 16$IDC_CMOS')  #hash Измерение 16$IDC_CMOS: 2    ;5  ;20  ;CMOS ;3  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=2.5,  value_limit=5, percent_error=20,  wave='CMOS', amplitude=4,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 17$IDC_CMOS')  #hash Измерение 17$IDC_CMOS: 2.5  ;5  ;20  ;CMOS ;4  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=3,    value_limit=5, percent_error=20,  wave='CMOS', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 18$IDC_CMOS')  #hash Измерение 18$IDC_CMOS: 3    ;5  ;20  ;CMOS ;5  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=4,    value_limit=5, percent_error=20,  wave='CMOS', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 19$IDC_CMOS')  #hash Измерение 19$IDC_CMOS: 4    ;5  ;20  ;CMOS ;5  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=5,    value_limit=5, percent_error=20,  wave='CMOS', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 20$IDC_CMOS')  #hash Измерение 20$IDC_CMOS: 5    ;5  ;20  ;CMOS ;5  ;10  ;10к  ;0.050  ;Да  ;3
...
IDC(value=0.01, value_limit=5, percent_error=220, wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=3.00, remeasurement=True, remeasurement_number=3, hash='Измерение 1$IDC_PULSE')   #hash Измерение 1$IDC_PULSE:  0.01 ;5  ;230 ;pulse ;1  ;10  ;10к  ;0.800  ;Да  ;3
IDC(value=0.03, value_limit=5, percent_error=110, wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 2$IDC_PULSE')   #hash Измерение 2$IDC_PULSE:  0.03 ;5  ;110 ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.05, value_limit=5, percent_error=55,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 3$IDC_PULSE')   #hash Измерение 3$IDC_PULSE:  0.05 ;5  ;55  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.1,  value_limit=5, percent_error=35,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 4$IDC_PULSE')   #hash Измерение 4$IDC_PULSE:  0.1  ;5  ;35  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.15, value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 5$IDC_PULSE')   #hash Измерение 5$IDC_PULSE:  0.15 ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.2,  value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 6$IDC_PULSE')   #hash Измерение 6$IDC_PULSE:  0.2  ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.25, value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 7$IDC_PULSE')   #hash Измерение 7$IDC_PULSE:  0.25 ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.3,  value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 8$IDC_PULSE')   #hash Измерение 8$IDC_PULSE:  0.3  ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.4,  value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 9$IDC_PULSE')   #hash Измерение 9$IDC_PULSE:  0.4  ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.5,  value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 10$IDC_PULSE')  #hash Измерение 10$IDC_PULSE: 0.5  ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.6,  value_limit=5, percent_error=20,  wave='pulse', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 11$IDC_PULSE')  #hash Измерение 11$IDC_PULSE: 0.6  ;5  ;20  ;pulse ;1  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=0.8,  value_limit=5, percent_error=20,  wave='pulse', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 12$IDC_PULSE')  #hash Измерение 12$IDC_PULSE: 0.8  ;5  ;20  ;pulse ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1,    value_limit=5, percent_error=20,  wave='pulse', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 13$IDC_PULSE')  #hash Измерение 13$IDC_PULSE: 1    ;5  ;20  ;pulse ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1.2,  value_limit=5, percent_error=20,  wave='pulse', amplitude=2,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 14$IDC_PULSE')  #hash Измерение 14$IDC_PULSE: 1.2  ;5  ;20  ;pulse ;2  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=1.5,  value_limit=5, percent_error=20,  wave='pulse', amplitude=3,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 15$IDC_PULSE')  #hash Измерение 15$IDC_PULSE: 1.5  ;5  ;20  ;pulse ;3  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=2,    value_limit=5, percent_error=20,  wave='pulse', amplitude=3,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 16$IDC_PULSE')  #hash Измерение 16$IDC_PULSE: 2    ;5  ;20  ;pulse ;3  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=2.5,  value_limit=5, percent_error=20,  wave='pulse', amplitude=4,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 17$IDC_PULSE')  #hash Измерение 17$IDC_PULSE: 2.5  ;5  ;20  ;pulse ;4  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=3,    value_limit=5, percent_error=20,  wave='pulse', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 18$IDC_PULSE')  #hash Измерение 18$IDC_PULSE: 3    ;5  ;20  ;pulse ;5  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=4,    value_limit=5, percent_error=20,  wave='pulse', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 19$IDC_PULSE')  #hash Измерение 19$IDC_PULSE: 4    ;5  ;20  ;pulse ;5  ;10  ;10к  ;0.050  ;Да  ;3
IDC(value=5,    value_limit=5, percent_error=20,  wave='pulse', amplitude=5,  amplitude_limit=10, frequency='10к', time_delay=1.50, remeasurement=True, remeasurement_number=3, hash='Измерение 20$IDC_PULSE')  #hash Измерение 20$IDC_PULSE: 5    ;5  ;20  ;pulse ;5  ;10  ;10к  ;0.050  ;Да  ;3
...
IDC(value=0.01, value_limit=5, percent_error=220, wave='ramp', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=3.00, remeasurement=True, remeasurement_number=3, hash='Измерение 1$IDC_RAMP')   #hash Измерение 1$IDC_RAMP:  0.01 ;5  ;230 ;ramp ;1  ;10  ;10к  ;0.800  ;Да  ;3
