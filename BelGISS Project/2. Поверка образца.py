...
a = bool(MOKO.Messenger('get', 'Образец', 'Пожалуйста, проведите внешний осмотр образца. Соответствует ли внешний вид образца '
...
MOKO.Messenger('set', 'Пауза между измерениями', 'Пожалуйста, подождите 5 минут между измерениями.', 'void', '300')
