...
if language == "English":
    MOKO.Messenger('set', 'Greeting.jpg', 'Additional features of Report and Messenger will be shown in the current project.')
elif language == "Русский":
    MOKO.Messenger('set', 'Greeting.jpg', 'В текущем проекте будут показаны дополнительные возможности Report и Messenger.')
