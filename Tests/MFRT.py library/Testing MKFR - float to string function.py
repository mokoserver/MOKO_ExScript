...
MOKO.Messenger("set", "Description#@info",
...
MOKO.Report('FloatConvertingRefNumber', 'info', 'table', 'Input value#130;'
                                                         'Reference number#130;'
                                                         'Resolution#75;'
                                                         'Prefix#50;'
                                                         'Delimiter#75;'
...
MOKO.Report('IntegerConvertingRefNumber', 'info', 'table', 'Input value#130;'
                                                           'Reference number#130;'
                                                           'Resolution#75;'
                                                           'Prefix#50;'
                                                           'Delimiter#75;'
...
MOKO.Report('ConvertingRefNumberRes', 'info', 'table', 'Input value#130;'
                                                       'Reference number#130;'
                                                       'Resolution#75;'
                                                       'Prefix#50;'
                                                       'Delimiter#75;'
...
for input_value in test_list_value:
    for reference_number in test_list_reference_number:
        ...
        MOKO.Report('ConvertingRefNumberRes', 'set', 'table', f'{input_value};'
                                                              f'{reference_number};'
                                                              f'{resolution};'
                                                              f'{prefix};'
                                                              f'{delimiter};'
...
MOKO.Report('ConvertingRefNumberResDel', 'info', 'table', 'Input value#130;'
                                                          'Reference number#130;'
                                                          'Resolution#75;'
                                                          'Prefix#50;'
                                                          'Delimiter#75;'
...
for input_value in test_list_value:
    for reference_number in test_list_reference_number:
        output_value = MFRT.ConvertFloatToString(input_value, reference_number, resolution=resolution,
                                                 delimiter=delimiter)
        MOKO.Report('ConvertingRefNumberResDel', 'set', 'table', f'{input_value};'
                                                                  f'{reference_number};'
                                                                  f'{resolution};'
                                                                  f'{prefix};'
                                                                  f'{delimiter};'
...
MOKO.Report('ConvertingRefNumberResDelPrefix', 'info', 'table', 'Input value#130;'
                                                                'Reference number#130;'
                                                                'Resolution#75;'
                                                                'Prefix#50;'
                                                                'Delimiter#75;'
...
for input_value in test_list_value:
    for reference_number in test_list_reference_number:
        ...
        MOKO.Report('ConvertingRefNumberResDelPrefix', 'set', 'table', f'{input_value};'
                                                                       f'{reference_number};'
                                                                       f'{resolution};'
                                                                       f'{prefix};'
                                                                       f'{delimiter};'
...
MOKO.Report('ConvertingValueResDelPrefix', 'info', 'table', 'Input value#130;'
                                                            'Reference number#130;'
                                                            'Resolution#75;'
                                                            'Prefix#50;'
                                                            'Delimiter#75;'
...
for input_value in test_list_input_value:
    ...
    MOKO.Report('ConvertingValueResDelPrefix', 'set', 'table', f'{input_value};'
                                                               f'{reference_number};'
                                                               f'{resolution};'
                                                               f'{prefix};'
                                                               f'{delimiter};'
