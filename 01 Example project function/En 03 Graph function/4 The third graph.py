...
#First Plot
name = "Plot 7" #hash Sinus with frequency 4: 4;(4);0;2;Magenta;Yes;
...
name = "Plot 8"     #hash Sinus with frequency 30:  30;(30);0;2;DarkTurquoise;Yes;
...
MOKO.Report("Screenshot_3_All", 'set', 'picture', screen)
