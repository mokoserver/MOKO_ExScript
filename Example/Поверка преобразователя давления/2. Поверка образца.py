...
#Region 2.1 hesh/параметры
#description: Эталонное давление;Ед. измерения;Действительное давление;Ед. измерения;
#hesh The first point: 2.0;МПа;2.01;МПа
#hesh The second point: 4.0;МПа;3.98;МПа
#hesh The third point: 6.0;МПа;6.0;МПа
#hesh The fouth point: 8.0;МПа;8.025;МПа
#hesh The fifth point: 10.0;МПа;9.98;МПа
...
MOKO.Messenger('set', 'Ожидание2.jpg', 'Пожалуйста, подождите 5 минут между измерениями.', 'void', '300')
