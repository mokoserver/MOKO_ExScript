...
IDC(value=0.01, value_limit=5, percent_error=230, wave='ramp', amplitude=1,  amplitude_limit=10, frequency='10к', time_delay=0.80, remeasurement=True, remeasurement_number=3, hesh='Измерение 1$IDC_RAMP')   #hesh Измерение 1$IDC_RAMP:  0.01 ;5  ;230 ;ramp ;1  ;10  ;10к  ;0.800  ;Да  ;3
