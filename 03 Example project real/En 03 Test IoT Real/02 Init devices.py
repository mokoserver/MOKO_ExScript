...
BK1697B_INIT = MOKO.Driver('BK1697B', 'init', '', 'string')
MOKO.Report("DevicesUsed", "set", "table", f"BK1697B; {BK1697B_INIT}")
MOKO.Stage(" ")
...
FY6900_INIT = MOKO.Driver('FY6900', 'init', '', 'string')
MOKO.Report("DevicesUsed", "set", "table", f"FY6900_INIT; {FY6900_INIT}")
MOKO.Stage(" ")
...
APPA207_INIT = MOKO.Driver('APPA207', 'init', '', 'string')
MOKO.Report("DevicesUsed", "set", "table", f"APPA207; {APPA207_INIT}")
MOKO.Stage(" ")
