...
a = bool(MOKO.Messenger('get', 'Instrument inspection.jpg', 'Пожалуйста, проведите внешний осмотр образца. Соответствует ли внешний вид образца '
...
MOKO.Messenger('set', 'Wait1.jpg', 'Пожалуйста, подождите 5 минут между измерениями.', 'void', '300')
MOKO.Messenger('set', 'Wait2.jpg', 'Пожалуйста, подождите 5 минут между измерениями.', 'void', '300')
MOKO.Messenger('set', 'Wait3.jpg', 'Пожалуйста, подождите 5 минут между измерениями.', 'void', '300')
